...
def get_parser():
    ...
    parser.add_argument('--train_img_dirs', default="LPRNet_Pytorch/data/test", help='the train images path')
    ...
    parser.add_argument('--save_folder', default='LPRNet_Pytorch/weights/', help='Location to save checkpoint models')
